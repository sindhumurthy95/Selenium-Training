3:00 to 3:15 ---> Course Introduction
3.15 to 3.25 ---> Mentor Introduction
3:25 to 3:30 ---> Break
3:30 to 4:15 ---> CoreJavaIntroduction
4:15 to 4:30 ---> Breakout
4:30 to 5:00 ---> DataTypes and Variables
5:00 to 5:20 ---> Breakout+Break
5:20 to 6:00 ---> Operators & Conditional Statements
6:00 to 6:15 ---> Recap
